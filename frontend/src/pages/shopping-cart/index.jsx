...
const ShoppingCart = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Shopping Cart - Avira Udupu | Review Your Natural Products</title>
        ...
        <meta name="keywords" content="shopping cart, natural products, organic food, checkout, free shipping, Avira Udupu" />
      </Helmet>
